...
const UIController = (function() {
    ...
    return{
        ...
        createPictires(img, name, artistLink, genres, tracks){
            ...
            <div class="list-group-item row col-sm-12 px-6">
                <strong>Artist</strong>
                <br>
                <a href="${artistLink}" id="Artist_Click" target="_blank">${name}</a>
            </div>
            
            <div class="list-group-item list-group-item-action row col-sm-12 px-6">
                <strong> Genre(s)</strong>
                <br> 
                <label for="Genre" class="form-label col-sm-12">${genres}</label>
            </div>
            <div class="list-group-item list-group-item-action row col-sm-12 px-6">
                <strong>Top Songs</strong>
                <br>
                <label for="Genre" class="form-label col-sm-12">${tracks}</label>
            </div>
            `;
